...
ldap quota selinux syslog systemd test winbind heimdal kerberos"
...
src_configure() {
	...
	### Removed lines from above
#		--bundled-libraries=NONE \
#		--builtin-libraries=NONE \

	### Enabling this option below removes samba-tool
	#use "kerberos" && myconf+=" --with-system-mitkrb5"
